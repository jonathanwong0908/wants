          ...
          <NativeOnlyAnimatedView entering={FadeIn}>
            <TextClassContext.Provider value="text-popover-foreground">
              <DropdownMenuPrimitive.Content
                className={cn(
                  "min-w-[12rem] overflow-hidden rounded-2xl border border-border bg-popover p-1 shadow-lg shadow-black/5",
                  className
                )}
                {...props}
              />
  ...
  return (
    ...
    >
      <DropdownMenuPrimitive.Item
        className={cn(
          "group relative flex flex-row items-center gap-2 rounded-sm px-2 py-1.5 active:bg-accent sm:py-1.5",
          Platform.select({
            web: cn(
