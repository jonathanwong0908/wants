...
- **Onboarding stack** (S1 → S2 → S3): shown on first run, gated by `onboarding_complete` setting
...
### S6 — Push notification *(system notification, not a screen)*
...
- Skipping: update status to `skipped`, cancel notification, navigate to S8
- Buying: update status to `bought`, cancel notification, navigate to S9

### S8 — Skipped / "You saved it!" *(modal)*

- "You saved [price]!"
- Running total: "That's [total] saved overall 🎉"
- CTA: "Back to home"

### S9 — Bought / "Logged!" *(modal)*
...
### S11 — Settings *(modal or pushed screen)*
